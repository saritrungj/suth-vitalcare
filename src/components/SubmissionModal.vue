<template>
  <transition name="sm-fade">
    <div v-if="open" class="sm-overlay" @click.self="$emit('close')">
      <div class="sm-card">
        <!-- Header -->
        <header class="sm-header">
          <div class="sm-user">
            ...
            <div class="sm-user-meta">
              ...
              <p class="sm-sub">{{ langStore.t("recent_submissions") }}</p>
            </div>
          </div>
          <button
            class="sm-close"
              ...
              <div class="sm-item-main">
                ...
                <div class="sm-item-bottom">
                  <span class="sm-value">
                    ...
                    <span class="sm-unit">{{
                      sub.tasks?.metric_unit || unitShort
                    }}</span>
                  </span>
...
const badgeClass = (status: string) =>
  STATUS_CLASS[status] || "sm-badge--pending";
...
// Show only the most recent submissions to keep the list scannable.
